const profiles = [
  ...
  },
  {
    ...
    imageLayout: "portrait",
    imagePosition: "50% 38%",
    intro: "大家好，我是来自龙州北路支行的黄欣，目前是一名助理综合服务经理。",
  ...
  },
  {
    ...
    imagePosition: "50% 50%",
    intro: "周欣妍的个人介绍待补充，敬请期待。",
    reflection: "周欣妍的廉洁感悟待补充，敬请期待。",
    keyword: "待补充",
    pending: true,
  },
];
...
function renderProfile(direction = "next") {
  ...
  document.querySelector("#profile-status").textContent = profile.pending ? "资料\n待补充" : "清廉\n感悟";
